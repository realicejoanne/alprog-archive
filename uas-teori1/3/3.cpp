...
//Soal no. 3: Perkalian matriks

typedef int mtx[10][10];
...
void hasil(int& a,int& b,int& c,int& c1,int& c2,int& d1,int& d2,mtx& x,mtx& y,mtx& mul){
...
int main(){
	...
	hasil(i,j,k,r1,r2,c1,c2,a,b,mul);
}